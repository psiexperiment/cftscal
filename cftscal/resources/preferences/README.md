...
itself uses as the directory key under `PSI_PREFERENCES_ROOT`.

These are seeded into psiexperiment's `PSI_PREFERENCES_ROOT`
...
resulting file from `<PSI_PREFERENCES_ROOT>/<paradigm_name>/default.preferences`
into this directory.
